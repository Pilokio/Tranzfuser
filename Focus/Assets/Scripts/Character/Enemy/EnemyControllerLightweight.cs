...
public class EnemyControllerLightweight : MonoBehaviour
{
...
//    void ReturnToIdle()
//    {
//        if (AlertStatus == EnemyUtility.AlertState.Suspicious)
//        {
//            SearchTimer = TimeForSearch;
...
//    IEnumerator BeSuspicious()
//    {
//        yield return new WaitForSeconds(5.0f);

//        if (AlertStatus == EnemyUtility.AlertState.Hostile && !TargetSighted)
//        {
//            AlertStatus = EnemyUtility.AlertState.Suspicious;
//        }
...
//        if (AlertStatus == EnemyUtility.AlertState.Hostile)
//        {
//            AlertStatus = EnemyUtility.AlertState.Suspicious;
//        }
//        SwitchingToSuspicious = false;
